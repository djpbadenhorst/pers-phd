...
class test_pypgm(unittest.TestCase):
    ...
    def test_01(self):
        ...
        self.pgm.connect_fnodes('f(x,y,w,p)', 'f(p)', ['p'])
    ...
    def test_02(self):
        ...
        belief_before = self.pgm.get_belief_parameters('f(p)')
        self.pgm.update_belief('f(p)')
        belief_after = self.pgm.get_belief_parameters('f(p)')
    ...
    def test_03(self):
        ...
        message_before = self.pgm.get_message_parameters('f(x,y,w,p)','f(p)')
        ...
        self.pgm.update_message('f(x,y,w,p)', 'f(p)')
        message_after = self.pgm.get_message_parameters('f(x,y,w,p)', 'f(p)')
